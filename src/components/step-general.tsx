...
const StepGeneral = ({ form }: { form: any }) => {
  return (
    <div className="flex flex-col sm:flex-row justify-start sm:shadow-gray-600 sm:shadow-lg p-4 gap-4">
              ...
              {e.value ? (
                <>
                  <Controller
                    ...
                    render={({ field }) => (
                      <>
                        <Label className="font-bold text-xs">Leadership</Label>
                        <Input
                          {...field}
                          type="number"
                          min={700}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <>
                        <Label className="font-bold text-xs">Preferences</Label>
                        <Input
                          {...field}
                          type="number"
                          min={1}
