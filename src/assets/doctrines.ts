...
export const epicDoctrines: Doctrine[] = [
  ...
  },
  {
    ...
    img: "/doctrines/hwarangpurple.png",
    forUnit: ["Hwarang"],
    dedicated: "unit",
...
export const rareDoctrines: Doctrine[] = [
  ...
  {
    name: "Doctrine Helot Auxiliaries",
    img: "/doctrines/auxiliaries.png",
    forUnit: ["Helot Auxiliaries"],
    dedicated: "unit",
    stats: "Helot Auxiliaries",
  },
];
